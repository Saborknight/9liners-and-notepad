call nln_mm_fnc_savePage;
closeDialog 0;
nln_nineliners_and_notepad_currentResource = "marking_mission";

while {nln_nineliners_and_notepad_currentResource == "marking_mission"} do
{
	cutRsc ["nln_marking_mission_resource","plain"];
	_lastpage = call nln_mm_fnc_GetLastPage;
	_pagetext = [_lastpage] call nln_mm_fnc_GetPageText;

	disableSerialization;
	_mm_namespace = uiNamespace getVariable "nln_mm_resource";
