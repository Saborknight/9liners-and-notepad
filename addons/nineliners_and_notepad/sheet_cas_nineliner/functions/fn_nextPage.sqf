...
private _nP = (["cas_nineliner", _lP] call nln_fnc_getNextPage);

if (_nP <= -1) then
{
	private _pP = (["cas_nineliner", _lP] call nln_fnc_getPagePosition);
...
{
	private _pP = (["cas_nineliner", _nP] call nln_fnc_getPagePosition);
